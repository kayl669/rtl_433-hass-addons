...
* Use `https://github.com/kayl669/rtl_433-hass-addons` as the URL for the repository.
...
* The [next](https://github.com/kayl669/rtl_433-hass-addons/tree/next) branch represents the upcoming version of these addons.
